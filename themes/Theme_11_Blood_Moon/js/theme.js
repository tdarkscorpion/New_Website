// Blood Moon Eclipse Interactive Particle Engine (bloodmoon-canvas)
(function() {
  ...
  function initThemeEngine() {
    ...
    const canvas = document.getElementById('bloodmoon-canvas');
    if (!canvas) return;
    initialized = true;
    ...
    const colors = ["#ef4444", "#b91c1c", "#fca5a5", "#7f1d1d"];
