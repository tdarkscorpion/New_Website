// Glacial Frost Peak Interactive Particle Engine (glacial-canvas)
(function() {
  ...
  function initThemeEngine() {
    ...
    const canvas = document.getElementById('glacial-canvas');
    if (!canvas) return;
    initialized = true;
    ...
    const colors = ["#38bdf8", "#bae6fd", "#ffffff", "#7dd3fc"];
