-- ================================================================
-- Talisman Online WebSuite — Complete Master Setup SQL
-- Generated: 2026-09-22 05:27:24
-- Complete schemas for db_account, db_game, db_misc & default seed data
-- ================================================================
...
-- Table structure for `card_sn`
CREATE TABLE IF NOT EXISTS `card_sn` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `card_no` varchar(64) NOT NULL,
  `card_pwd` varchar(64) DEFAULT '',
  `type_id` int(11) NOT NULL DEFAULT '1',
  `status` tinyint(4) NOT NULL DEFAULT '0',
  `used_role_id` int(11) DEFAULT '0',
  `used_account` varchar(64) DEFAULT '',
...
-- Table structure for `db_valid_ip`
CREATE TABLE IF NOT EXISTS `db_valid_ip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account_name` varchar(50) NOT NULL,
  `wan_ip` varchar(50) NOT NULL,
...
-- Table structure for `t_card_saving`
...
-- Table structure for `t_card_sn`
CREATE TABLE IF NOT EXISTS `t_card_sn` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `card_no` varchar(64) NOT NULL,
  `card_pwd` varchar(64) DEFAULT '',
  `type_id` int(11) NOT NULL DEFAULT '1',
...
-- Table structure for `t_gold_saving`
...
-- Table structure for `t_gold_used`
...
-- Table structure for `t_log_acct`
...
-- Table structure for `t_log_gitem`
...
-- Table structure for `request_teacher_list`
...
-- Table structure for `t_defend_equip_rank`
...
-- Table structure for `t_guild_kill_record`
...
-- Table structure for `t_guild_war_pair`
...
-- Table structure for `t_main_trump_rank`
...
-- Table structure for `t_pve_rank`
...
-- Table structure for `t_storage_item`
...
-- Table structure for `t_user_dungeon_team`
...
-- Table structure for `t_user_guild`
...
-- Table structure for `t_user_guild_terr`
...
-- Table structure for `t_war_area`
...
-- Table structure for `file_checksums`
...
-- Table structure for `t_admin_api_keys`
CREATE TABLE IF NOT EXISTS `t_admin_api_keys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `admin_accountid` int(11) NOT NULL,
  `admin_username` varchar(50) NOT NULL,
  `api_key` varchar(64) NOT NULL,
  `api_secret` varchar(64) NOT NULL,
  `label` varchar(100) DEFAULT 'Admin Tool',
...
-- Table structure for `t_case_answers`
...
-- Table structure for `t_case_attachments`
...
-- Table structure for `t_cases_close`
...
-- Table structure for `t_cmd_logs`
...
-- Table structure for `t_crawl_news`
...
-- Table structure for `t_donate_itens`
...
-- Table structure for `t_donation_messages`
CREATE TABLE IF NOT EXISTS `t_donation_messages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Table structure for `t_donations`
...
-- Table structure for `t_game_notification`
CREATE TABLE IF NOT EXISTS `t_game_notification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Table structure for `t_gift_itens`
...
-- Table structure for `t_gift_kills`
...
-- Table structure for `t_gift_ranking`
...
-- Table structure for `t_gift_time`
...
-- Table structure for `t_gift_votes`
...
-- Table structure for `t_give_itens`
...
-- Table structure for `t_image_event`
...
-- Table structure for `t_nick_change`
...
-- Table structure for `t_package_logs`
CREATE TABLE IF NOT EXISTS `t_package_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Table structure for `t_payment_packages`
CREATE TABLE IF NOT EXISTS `t_payment_packages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Table structure for `t_payment_validate`
...
-- Table structure for `t_paymentsbr`
...
-- Table structure for `t_point_sale`
...
-- Table structure for `t_ref_char`
CREATE TABLE IF NOT EXISTS `t_ref_char` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_name` (`Name`),
  KEY `idx_refby` (`ReferredBy`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Table structure for `t_refer`
...
-- Table structure for `t_reset_itens`
...
-- Table structure for `t_screenshot_views`
...
-- Table structure for `t_screenshot_votes`
...
-- Table structure for `t_screenshots`
...
-- Table structure for `t_screenshots_comments`
...
-- Table structure for `t_shop_itens`
...
-- Table structure for `t_shop_objects`
...
-- Table structure for `t_shop_package_itens`
CREATE TABLE IF NOT EXISTS `t_shop_package_itens` (
  `pid` smallint(6) NOT NULL,
  `objectID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Table structure for `t_shop_packages`
...
-- Table structure for `t_slider_images`
...
-- Table structure for `t_smtp_settings`
CREATE TABLE IF NOT EXISTS `t_smtp_settings` (
  `setting_key` varchar(100) NOT NULL,
  `setting_value` text,
  PRIMARY KEY (`setting_key`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Table structure for `t_gp_conversions`
CREATE TABLE IF NOT EXISTS `t_gp_conversions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account_name` varchar(50) NOT NULL,
  `account_id` bigint(21) NOT NULL DEFAULT '0',
  `gp_spent` int(11) NOT NULL,
  `yield_amount` int(11) NOT NULL,
...
-- Table structure for `t_staff_hide`
...
-- Table structure for `t_streamers`
...
-- Table structure for `t_update_files`
...
-- Table structure for `t_webshop_dispatch_status`
CREATE TABLE IF NOT EXISTS `t_webshop_dispatch_status` (
  `dispatch_id` int(11) NOT NULL AUTO_INCREMENT,
  `account_id` int(11) NOT NULL COMMENT 'User Account ID from db_account.t_account',
  `account_name` varchar(100) NOT NULL COMMENT 'User Account Name',
  `role_id` int(11) NOT NULL COMMENT 'Character/Role DBID (ObjID)',
  `role_name` varchar(100) NOT NULL COMMENT 'Character Name',
  `item_id` int(11) NOT NULL COMMENT 'In-game Item Type ID',
  `item_name` varchar(255) NOT NULL COMMENT 'Item Name',
  `quantity` int(11) DEFAULT '1' COMMENT 'Quantity Purchased',
  `bind_type` int(11) DEFAULT '0' COMMENT 'Bind State',
  `smith_level` int(11) DEFAULT '0' COMMENT 'Smithing Level (+0 to +12)',
  `duration` int(11) DEFAULT '0' COMMENT 'Duration in hours',
  `attribute_id` int(11) DEFAULT '0' COMMENT 'Attribute ID',
  `cost_type` enum('GD','GP','DP') NOT NULL COMMENT 'Currency Used',
  `cost_amount` int(11) NOT NULL COMMENT 'Total Currency Deducted',
  `status` tinyint(4) DEFAULT '0' COMMENT '0=Pending Dispatch, 1=Delivered Successfully, 2=Failed/Refunded',
  `error_message` varchar(255) DEFAULT NULL COMMENT 'Error Details if failed',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Table structure for `t_webshop_items`
CREATE TABLE IF NOT EXISTS `t_webshop_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL COMMENT 'In-game Item Type ID from item_desc.csv',
  `item_name` varchar(255) NOT NULL COMMENT 'Item Display Name',
  `category` varchar(50) NOT NULL DEFAULT 'General' COMMENT 'Item Category (Weapons, Armor, Gems, Consumables, Mounts, etc.)',
  `shop_type` enum('GD','GP','DP') NOT NULL DEFAULT 'GD' COMMENT 'Shop Currency Type: GD=T-Points, GP=Gift Points, DP=Donate Points',
  `price` int(11) NOT NULL DEFAULT '0' COMMENT 'Item Price in specified currency',
  `icon` varchar(255) DEFAULT 'ic_default' COMMENT 'Icon texture file name in ui/textures',
  `color` varchar(32) DEFAULT '#FFFFD700',
  `quantity` int(11) DEFAULT '1' COMMENT 'Stack amount per purchase',
  `bind_type` int(11) DEFAULT '0' COMMENT '0=Unbound, 1=Bound on Pick, 2=Bound on Equip',
  `smith_level` int(11) DEFAULT '0' COMMENT 'Initial Smithing/Plus Level (0-12)',
  `duration` int(11) DEFAULT '0' COMMENT 'Item Duration in hours (0 = Permanent)',
  `attribute_id` int(11) DEFAULT '0' COMMENT 'Special Attribute/Stat Modifier ID',
  `description` text COMMENT 'Item Hover Tooltip Description',
  `status` tinyint(4) DEFAULT '1' COMMENT '1=Active/Available, 0=Disabled',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- Table structure for `t_website_lottery_draws`
CREATE TABLE IF NOT EXISTS `t_website_lottery_draws` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Table structure for `t_website_lottery_entries`
CREATE TABLE IF NOT EXISTS `t_website_lottery_entries` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Table structure for `t_website_minigame_logs`
CREATE TABLE IF NOT EXISTS `t_website_minigame_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(50) NOT NULL,
...
-- Table structure for `t_website_minigames`
CREATE TABLE IF NOT EXISTS `t_website_minigames` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `game_key` varchar(50) NOT NULL,
...
-- Table structure for `t_website_options`
CREATE TABLE IF NOT EXISTS `t_website_options` (
  `option_name` varchar(100) NOT NULL,
  `option_value` varchar(255) NOT NULL,
  PRIMARY KEY (`option_name`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Default Data for `t_website_options`
